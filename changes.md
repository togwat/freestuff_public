...
This change allows a user to upload multiple pictures to a listing, with an image gallery on the listing's page. The first uploaded image would be used as the thumbnail for browsing.
